...
So I thought it would be a good idea to start a collection of clever domain names so that I can be find again easily. Feel free to open a PR and add to this list.
...
- [hasthesunexplodedyet.com](https://www.hasthesunexplodedyet.com/)
- [willtheworldend.com](http://willtheworldend.com/)

### Weather

- [doineedanumbrella.com](http://doineedanumbrella.com/)
- [isitdarkoutside.com](https://isitdarkoutside.com/)
- [isitgoingtorain.com](https://isitgoingtorain.com/)

### Calendar/Holidays

- [isitchristmas.com](https://isitchristmas.com/)
- [isitnewyearsday.com](https://isitnewyearsday.com/)
- [isitcaturday.com](https://isitcaturday.com/)
- [isitthursday.org](https://isitthursday.org/)
- [isleapyear.com](https://isleapyear.com/)
- [isittheweekendyet.com](https://www.isittheweekendyet.com/)
- [isitfridayyet.net](https://isitfridayyet.net/)
- [isitwednesdaymydudes.com](https://www.isitwednesdaymydudes.com/)
- [isitfriday.org](https://isitfriday.org/)

### Food/Drink

- [isitbeeroclock.com](https://isitbeeroclock.com/)
- [isitcoffeetime.com](https://isitcoffeetime.com/)
- [isitvegan.com](https://www.isitvegan.com/)
...
- [cat-bounce.com](https://cat-bounce.com/)
